...
function SkillEffect({ children, text }) {
  ...
  return (
    <>
      <div
        onClick={clickEffect}
        className="relative inline-block p-0 mx-2.5 mt-6 mb-10 sm:m-2 md:my-4 md:mx-2 text-6xl md:text-7xl 
      ...
      >
        ...
        <div className="absolute bottom-[-2.5rem] sm:bottom-[-2rem] left-[50%] translate-x-[-50%] w-full font-bold text-sm text-center">
          {text}
        </div>
      </div>
    </>
