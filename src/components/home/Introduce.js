    ...
    <>
      <IntroduceWarper>
        ...
        <div>
          ...
          <br />
          <SpanStyled>
            독학을 하여 스스로 찾고 연마하는 <u>프로자습러</u>입니다.
            <br /> 그렇기 때문에 저는 클론 개발자가 아닌 신선한 개발자입니다.
          </SpanStyled>
          <br />
          <br />
          <br />
          <SpanStyled>
            개발은 혼자하는 작업이 아니라는 것 잘 알고있습니다.
            <br /> 독학이라는 단점을 극복하기 위해서 <br /> 예비 개발자 4명과
            함께 1개월 간 <u> 모각코</u>를 운영하며 지식을 공유 했습니다.
            <br /> 또한 광고회사에 1년간 기획자로서 재직하며 디자이너와의
            <br />
